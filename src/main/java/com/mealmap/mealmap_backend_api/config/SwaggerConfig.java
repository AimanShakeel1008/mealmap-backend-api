                ...
                .components(new io.swagger.v3.oas.models.Components()
                        .addSecuritySchemes("adminBearerAuth",
                                new SecurityScheme()
                                        ...
                                        .scheme("bearer")
                                        .bearerFormat("JWT")
                                        .description("Admin token for admin role"))
                        .addSecuritySchemes("customerBearerAuth",
                                new SecurityScheme()
                                        .type(SecurityScheme.Type.HTTP)
                                        .scheme("bearer")
                                        .bearerFormat("JWT")
                                        .description("Customer token for Customer role"))
                        .addSecuritySchemes("restaurantOwnerBearerAuth",
                                new SecurityScheme()
                                        .type(SecurityScheme.Type.HTTP)
                                        .scheme("bearer")
                                        .bearerFormat("JWT")
                                        .description("Customer token for Restaurant Owner role"))
                        .addSecuritySchemes("deliveryPersonnelBearerAuth",
                                new SecurityScheme()
                                        .type(SecurityScheme.Type.HTTP)
                                        .scheme("bearer")
                                        .bearerFormat("JWT")
                                        .description("Customer token for Delivery Personnel role"))
                )
